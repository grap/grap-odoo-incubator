...
class AccountInvoiceLine(models.Model):
    ...
    def _is_correct_partner_info(self, partnerinfo):
        res = super(AccountInvoiceLine, self)._is_correct_partner_info(
            partnerinfo)
        return res and\
            self.discount2 == partnerinfo.discount2 and\
            self.discount3 == partnerinfo.discount3
    ...
    def _prepare_supplier_wizard_line(self, supplierinfo, partnerinfo):
        ...
        res['current_discount2'] = partnerinfo and partnerinfo.discount2
        res['new_discount2'] = self.discount2
        res['current_discount3'] = partnerinfo and partnerinfo.discount3
