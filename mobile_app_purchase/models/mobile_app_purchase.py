...
class MobileAppPurchase(models.TransientModel):
    ...
    def get_purchase_orders(self):
        ...
        return [self._export_purchase_order(order) for order in orders]
    ...
    def get_partners(self):
        ...
        return [self._export_partner(partner) for partner in partners]
    ...
    def get_products(self, params):
        ...
        return [
            self._export_product(
                product, partner, custom_fields, supplierinfo_fields
            )
    ...
    def search_barcode(self, params):
        ...
        if not products:
            ...
            return self._export_product(
                products[0], partner, custom_fields, supplierinfo_fields
            )
    ...
    def add_purchase_order_line(self, params):
        ...
        line_vals.update({"product_id": product_id, "order_id": order.id})
            ...
            for field_name, field_display in supplierinfo_fields.iteritems():
                if field_name[-3:] == "_id":
                    ...
                    value = ", ".join(
                        [
                            attr.name
                            for attr in getattr(supplierinfo, field_name)
                        ]
                    )
                else:
    ...
    def _extract_param(self, params, value_path):
        ...
        if "." in value_path:
            ...
            return self._extract_param(
                params.get(first_key), ".".join(value_path_split[1:])
            )
        else:
