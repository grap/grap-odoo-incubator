        ...
        result.update(
            {
                ...
                "supplierinfo_min_qty": supplierinfo and supplierinfo.min_qty or 0.0,
                "supplierinfo_uom_po_id": supplierinfo
                and supplierinfo.product_uom.id
                or False,
                "supplierinfo_uom_po_name": supplierinfo
                and supplierinfo.product_uom.name
                or False,
            }
        )
