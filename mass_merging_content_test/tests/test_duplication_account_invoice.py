...
class TestModule(TransactionCase):
    ...
    def setUp(self):
        ...
        self.merging_content = self.env('mass_merging_content.merging_invoice')
        self.invoice = self.env.ref(
            'mass_merging_content.invoice.invoice_to_merge')
    ...
    def test_01_merge_wizard(self):
        wizard = self.wizard_obj.with_context(
            ...
            mass_operation_mixin_name='mass.merging.content.wizard',
